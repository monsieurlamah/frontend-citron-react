...
import { FiHeadphones, FiLayers, FiUsers } from "react-icons/fi";
...
export const services = [
  {
    ...
    text: "Nous vous aidons à acheter ou vendre des biens immobiliers en toute confiance, au meilleur prix.",
  },
  {
    id: 2,
    name: "Location de logements",
    icon: <BiHomeAlt />,
    text: "Accédez à une sélection variée de logements à louer, adaptés à vos besoins et à votre budget.",
  },
  {
    id: 3,
    name: "Construction de bâtiments",
    icon: <BiFullscreen />,
    text: "Nous réalisons vos projets de construction avec professionnalisme, rigueur et qualité.",
  },
  {
    id: 4,
    name: "Conception architecturale",
    icon: <FiLayers />,
    text: "Plans modernes et personnalisés pour une architecture innovante, fonctionnelle et élégante.",
  },
  {
    id: 5,
    name: "Rénovation & remodelling",
    icon: <FaPaintRoller />,
    text: "Nous rénovons maisons, bureaux et espaces professionnels pour leur redonner vie et style.",
  },
  {
    id: 6,
    name: "Mise en relation client-prestataire",
    icon: <FiUsers />,
    text: "Trouvez rapidement des artisans qualifiés pour tous vos travaux via notre plateforme dédiée.",
  },
];
