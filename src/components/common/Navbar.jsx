...
const Navbar = () => {
  ...
  return (
    <div className="navbar fixed w-full z-20 top-0 left-0 py-2 bg-white/60 border-b backdrop-blur-sm dark:border-dark dark:bg-card-dark/60" onMouseOver={handleClose}>
      <div className="max-w-7xl mx-auto px-4 flex-center-between">
        <Link to="/" className="flex-shrink-0 flex items-center gap-x-2">
          <img src="/logo.png" alt="Logo Citron Guinée" className="h-10 w-auto object-contain" />
          <h1 className="hidden md:hidden font-semibold text-lg text-primary">Citron Guinée</h1>
        </Link>
